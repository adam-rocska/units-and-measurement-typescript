...
describe("angle", () => {
  describe('°', () => {
    ...
    it.each([1, 10, 100])('should convert ʹ to °.', v => {
      ...
      const expected = [toBase(fromBase(v)), "°"] as const;
  ...
  describe('ʹ', () => {
    ...
    it.each([1, 10, 100])('should convert ° to ʹ.', v => {
      ...
      const expected = [toBase(fromBase(v)), "ʹ"] as const;
  ...
  describe('ʺ', () => {
    ...
    it.each([1, 10, 100])('should convert ° to ʺ.', v => {
      ...
      const expected = [toBase(fromBase(v)), "ʺ"] as const;
      const conversionCandidate = [v, "°"] as const;
  ...
  describe('rad', () => {
    ...
    it.each([1, 10, 100])('should convert ° to rad.', v => {
      ...
      const expected = [toBase(fromBase(v)), "rad"] as const;
      const conversionCandidate = [v, "°"] as const;
  ...
  describe('grad', () => {
    ...
    it.each([1, 10, 100])('should convert ° to grad.', v => {
      ...
      const expected = [toBase(fromBase(v)), "grad"] as const;
      const conversionCandidate = [v, "°"] as const;
  ...
  describe('rev', () => {
    ...
    it.each([1, 10, 100])('should convert ° to rev.', v => {
      ...
      const expected = [toBase(fromBase(v)), "rev"] as const;
      const conversionCandidate = [v, "°"] as const;
