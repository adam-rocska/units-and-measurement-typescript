...
export class ElectricResistanceDimension extends Dimension<ElectricResistanceSymbol> {
  public static readonly megaohms = new ElectricResistanceDimension("MΩ", new LinearUnitConverter(1000000));

  public static readonly kiloohms = new ElectricResistanceDimension("kΩ", new LinearUnitConverter(1000));

  public static readonly ohms = new ElectricResistanceDimension("Ω", new LinearUnitConverter(1));
