...
export class ElectricPotentialDifferenceDimension extends Dimension<ElectricPotentialDifferenceSymbol> {
  public static readonly megavolts = new ElectricPotentialDifferenceDimension("MV", new LinearUnitConverter(1000000));

  public static readonly kilovolts = new ElectricPotentialDifferenceDimension("kV", new LinearUnitConverter(1000));

  public static readonly volts = new ElectricPotentialDifferenceDimension("V", new LinearUnitConverter(1));
